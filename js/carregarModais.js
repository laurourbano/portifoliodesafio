...
const conteudo = [
    ...
    {
        titulo2:"<h4>JavaScript</h4>",
        nome: "<p>JavaScript - linguagem de programação</p>",
    ...
    {
        titulo3:"<h4>Bootstrap</h4>",
        nome: "<p>Bootstrap - biblioteca de estilização</p>",
    ...
    {
        titulo4:"<h4>Font Awesome</h4>",
        nome: "<p>Font Awesome - biblioteca de ícones</p>",
...
titulo0.innerHTML = `${conteudo[0].titulo0}`;

const titulo1 = document.querySelector('.titulo1');
titulo1.innerHTML = `${conteudo[1].titulo1}`;

const titulo2 = document.querySelector('.titulo2');
titulo2.innerHTML = `${conteudo[2].titulo2}`;

const titulo3 = document.querySelector('.titulo3');
titulo3.innerHTML = `${conteudo[3].titulo3}`;

const titulo4 = document.querySelector('.titulo4');
titulo4.innerHTML = `${conteudo[4].titulo4}`;
